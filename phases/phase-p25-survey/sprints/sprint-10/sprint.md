# Sprint p25/10 — 按源快照重建完整 Survey 工作台与五步流程

- **所属阶段**: Phase p25 (survey)
- **创建于**: 2026-07-14 13:18:56

## 本 sprint 目标
按源快照重建完整 Survey 工作台与五步流程

## 领取的 feature(引用自阶段权威清单,按 id)
- F10 (P1, survey) — 按源快照重建完整 Survey 工作台与五步流程
...
## 完成标准
- 上述每个 feature 经 `pnpm harness verify --sprint p25/10` 门控为 `passing`。
