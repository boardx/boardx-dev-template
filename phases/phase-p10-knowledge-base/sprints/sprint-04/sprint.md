# Sprint p10/04 — F04 RAG 检索作用域隔离

- **所属阶段**: Phase p10 (knowledge-base)
- **创建于**: 2026-07-02 08:40:47

## 本 sprint 目标
F04 RAG 检索作用域隔离

## 领取的 feature(引用自阶段权威清单,按 id)
- F04 (P3, knowledge-base) — AI 引用知识库上下文（RAG 检索 + 作用域隔离）
...
## 完成标准
- 上述每个 feature 经 `pnpm harness verify --sprint p10/04` 门控为 `passing`。
