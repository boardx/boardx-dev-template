...
confirmed_at:      2026-07-08T10:00:00Z     # 确认时间（ISO，如 2026-07-01T10:00:00Z）
---
...
- 通过 AskUserQuestion 明确回答了「需要人类重点判断的问题」三项（2026-07-08）：
  1. 双栏布局窄屏/移动端降级：**本轮不做**，行为未定义，留待后续阶段评估。
  2. Studio 独立 tab 范围：**维持现状**——轻量落地页（近期产物列表 + 跳转聊天工作区），
     不做成独立生成工作台。
  3. Board 面包屑回退（优先级 3）：**这轮一起做**，纳入本阶段 feature 范围。
