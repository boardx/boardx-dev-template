# Sprint p14/01 — 积分钱包查看地基：Team Credits + 个人余额

- **所属阶段**: Phase p14 (credits-billing)
- **创建于**: 2026-07-01 09:04:01

## 本 sprint 目标
积分钱包查看地基：Team Credits + 个人余额

## 领取的 feature(引用自阶段权威清单,按 id)
- F01 (P1, credits) — 积分钱包查看（Team Credits 页 + 用户菜单个人余额）
...
## 完成标准
- 上述每个 feature 经 `pnpm harness verify --sprint p14/01` 门控为 `passing`。
