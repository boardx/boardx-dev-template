# Sprint p11/04 — 订阅并使用项目（个人/团队订阅+使用入口）

- **所属阶段**: Phase p11 (ai-store)
- **创建于**: 2026-07-02 04:49:40

## 本 sprint 目标
订阅并使用项目（个人/团队订阅+使用入口）

## 领取的 feature(引用自阶段权威清单,按 id)
- F03 (P2, ai-store) — 订阅并使用项目（个人/团队订阅 + 使用入口带入 AVA/工具/模板）
...
## 完成标准
- 上述每个 feature 经 `pnpm harness verify --sprint p11/04` 门控为 `passing`。
