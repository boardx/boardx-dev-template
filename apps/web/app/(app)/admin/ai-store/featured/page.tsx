...
// 占位目的地：AI Store 官方精选是 F05（blocked-on p11 + F04，独立 owner），此处只做门控 + 占位。
export default async function AdminAiStoreFeaturedPage() {
  ...
  return <ComingSoon title="AI Store 官方精选" />;
}
