"use client";
// F02（用户管理，另一 owner/后续 sprint）的既有原型页面，随 F01 建 /admin 骨架时从
// /admin 迁到 /admin/users（原路由被 F01 的后台首页占用）。本页自带的 isAdmin() 仍是
// 独立 stub 网关（见 app/api/admin/users/route.ts），尚未接入 F01 新增的真实
// SysAdmin(platform_role) 判定 —— 那是 F02 落地时的工作，此处不越权修改。
